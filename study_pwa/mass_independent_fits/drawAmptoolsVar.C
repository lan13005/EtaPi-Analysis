...
void drawAmptoolsVar(){
    ...
    string sm="104180";
    for (auto pol: pols){
        //flatHistFiles.push_back("/d/grid17/ln16/dselector_v2/test/phase1_selected/t"+st+"_m"+sm+"/pol"+pol+"_t"+st+"_m"+sm+"_FTOT_selected_acc_flat.root");
        //flatThrownHistFiles.push_back("/d/grid17/ln16/dselector_v2/test/phase1_selected/t"+st+"_m"+sm+"/pol"+pol+"_t"+st+"_m"+sm+"_FTOT_gen_data_flat.root");
        //totHistFiles.push_back("/d/grid17/ln16/dselector_v2/test/phase1_selected/t"+st+"_m"+sm+"/pol"+pol+"_t"+st+"_m"+sm+"_DTOT_selected_data_flat.root");
        ...
        //flatHistFiles.push_back("/d/grid17/ln16/dselector_v2/test/phase1_selected/tall_m080180/pol000_tall_m080180_F2018_8_selected_acc_flat.root");
        //flatThrownHistFiles.push_back("/d/grid17/ln16/dselector_v2/test/phase1_selected/tall_m080180/pol000_tall_m080180_F2018_8_gen_data_flat.root");
        //totHistFiles.push_back("/d/grid17/ln16/dselector_v2/test/kmatrix_selected/pol000_kmatrix_selected_data_flat.root");
        //sbHistFiles.push_back("/d/grid17/ln16/dselector_v2/test/kmatrix_selected/pol000_kmatrix_selected_bkgnd_flat.root");
        flatHistFiles.push_back("/d/grid17/ln16/dselector_v2/test/phase1_selected/tall_m080180/pol000_tall_m080180_F2018_8_gen_data_flat.root");
        flatThrownHistFiles.push_back("/d/grid17/ln16/dselector_v2/test/phase1_selected/tall_m080180/pol000_tall_m080180_F2018_8_gen_data_flat.root");
        totHistFiles.push_back("/d/grid17/ln16/dselector_v2/test/kmatrix_selected/pol000_kmatrix_gen_data_flat.root");
        sbHistFiles.push_back("");
    }
    ...
    vector<string> genHistFiles={"/d/grid17/ln16/dselector_v2/test/kmatrix_selected/pol000_kmatrix_gen_data_flat.root"};
